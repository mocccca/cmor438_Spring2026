...
class GradientBoostingPersonality:
    """
    Reusable Gradient Boosting regression model for predicting Big Five
    ...
    def _build_pipeline(self):
        """Build a TF-IDF + Gradient Boosting pipeline."""
        return Pipeline([
    ...
    def fit(self, X_train, y_train):
        """Fit one Gradient Boosting model per Big Five trait."""
